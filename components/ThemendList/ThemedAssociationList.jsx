...
import ThemedAssociationMenu from "../ThemedMenu/ThemedAssociationMenu";

const ThemedAssociationList = ({
    data,
    theme,
    expandedId,
    onEndReached,
                        ...
                        <View style={styles.details}>
                            <View>
                                <Text style={styles.detailText}>
                                    Assocation name: {item.agency?.name || "N/A"}
                                </Text>
                                <Text style={styles.detailText}>
                            ...
                            <View>
                                <ThemedAssociationMenu
                                    theme={theme}
                                    data={item}
                                    onForm={() =>
                                        router.push(
                                            `/dashboard/housing-applicants/association/association-members/${item?.uuid}`
                                        )
                                    }
                                />
                            </View>
...
export default ThemedAssociationList;