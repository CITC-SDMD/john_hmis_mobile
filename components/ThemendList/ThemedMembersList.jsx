...
import ThemedCard from "../ThemedForm/ThemedCard";
import ThemedMembersMenu from "../ThemedMenu/ThemedMembersMenu";

const ThemedMembersList = ({
    data,
    theme,
    expandedId,
    onEndReached,
            ...
            <TouchableOpacity onPress={() => onToggleExpand(item.id)}>
                <ThemedCard style={[styles.card, { backgroundColor: "#FBFDFF" }]}>
                    <Text style={styles.header}>
                        {item.firstname || "N/A"} {item.middlename || ""} {item.lastname || "N/A"}
                    </Text>
                        ...
                        <View style={styles.details}>
                            ...
                            <View>
                                <ThemedMembersMenu
                                    ...
                                    onForm={() =>
                                        router.push(
                                            `/dashboard/housing-applicants/association/application-form/${item?.uuid}`
                                        )
                                    }
                                />
                            </View>
...
export default ThemedMembersList;